...
## Properties on [ConformanceLevel]
The class of conformance levels. Includes the following individuals: `ddoc:mandatory`, `ddoc:recommended` and `ddoc:optional`.
...
[ConformanceLevel]: https://w3id.org/emmo/application/datadoc#ConformanceLevel
