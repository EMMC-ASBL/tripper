...
| [documentation]         | [foaf:Document], xsd:anyURI                | optional    | A page or document about this resource.                                                                                                      |                                                                                                                                                                                                       |
...
| [releaseDate]           | [rdfs:Literal], xsd:date                   | optional    | The date of formal issuance (e.g., publication) of the resource.                                                                             |                                                                                                                                                                                                       |
...
| [availability]   | [rdfs:Literal], xsd:date                | recommended | An indication how long it is planned to keep the Distribution of the Dataset available.                                                                            |                                                                                                                                                                           |
| [mediaType]      | [rdfs:Literal], xsd:string              | recommended | The media type of the Distribution as defined in the official register of media types managed by [IANA](https://www.w3.org/TR/vocab-dcat-3/#bib-iana-media-types). |                                                                                                                                                                           |
...
| Keyword      | Range                      | Conformance | Definition                                          | Usage note                                                                                                                                    |
| ------------ | -------------------------- | ----------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [name]       | [rdfs:Literal], xsd:string | mandatory   | A name of the agent.                                |                                                                                                                                               |
