...
| [curatedBy]             | [foaf:Agent]                                   |             | The agent that curated the resource.                                                                                                         | Use `issued` to refer to the date of curation.                                                                                                                                                        |
...
[curatedBy]: https://w3id.org/emmo/domain/oteio#curatedBy
[foaf:Agent]: http://xmlns.com/foaf/0.1/Agent
